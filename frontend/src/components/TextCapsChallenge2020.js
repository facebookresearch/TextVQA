...
const TextCapsChallenge = (props) => {
    ...
    const deadline = moment.tz("2020-05-18T23:59:59", "Etc/GMT").toDate();
        ...
        >
            ...
            >
                ...
                >
                        ...
                        <Grid container>
                            <Grid item xs={6} sm={4} lg={2}>
                                <Typography variant="h5" align="left">
                                    Powered by:
                                    <Link target="_blank" href="https://evalai.cloudcv.org/web/challenges/challenge-page/573/">
                                        <img
                    ...
                    <Grid item className={props.classes.overview} xs={12} md={8} lg={8}>
                        ...
                        <Typography variant="subtitle1" className={props.classes.headings} align="left">
                            ...
                            link: <Link
                                ...
                                target="_blank"
                                href="https://evalai.cloudcv.org/web/challenges/challenge-page/573/">
                                https://evalai.cloudcv.org/web/challenges/challenge-page/573/</Link>
                        </Typography>
                    </Grid>
                    ...
                    >
                        ...
                        >
                            <iframe
                                width="560"
                                height="315"
                                src="https://www.youtube.com/embed/9utGevwrSj8"
                                frameBorder="0"
                    ...
                    <Grid item className={props.classes.versionNumber} xs={12} md={8} lg={8}>
                        <Typography variant="subtitle1" align="left">
                            We will be providing the winners of the first TextCaps 2020 challenge, the second TextVQA 2020 challenge and
